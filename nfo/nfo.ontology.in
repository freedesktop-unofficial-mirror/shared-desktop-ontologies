...
Name[csb]=Ontologijo lopka Nepomuk
...
Name[hu]=Nepomuk fájlontológia
Name[kk]=Nepomuk файл онтологиясы
Name[km]=ប្រាណវិទ្យា​ឯកសារ Nepomuk
Name[kn]=ನೆಪೋಮುಕ್ ಕಡತ ಸತ್ತಾಶಾಸ್ತ್ರ (ಆಂಟಾಲಜಿ)
Name[ko]=Nepomuk 파일 온톨로지
Name[nds]=Dateiweeswark Nepomuk
Name[ne]=नेपोमक फाइल ओन्टोलोजी
Name[nl]=Nepomuk Bestandsontologie
Name[nn]=Nepomuk-filontologi
...
Name[zh_CN]=Nepomuk 文件实体
Comment=The Nepomuk File Ontology defines basic file types
Comment[ar]=يحدد عريف نيبوموك للملفات أنواع الملفات الأساسية
Comment[ca]=L'ontologia de fitxers del Nepomuk defineix els tipus bàsics dels fitxers
Comment[csb]=Òntologijô lopka Nepomuk definiuje pòdspòdlowé ôrtë lopka
...
Comment[hu]=A Nepomuk fájlontológia alapvető fájltípusokat definiál
Comment[kk]=Nepomuk файл онтологиясы деген файл түрлерін анықтайды
...
Comment[nb]=Nepomuk fil-ontologien definerer grunnleggende filtyper
...
Comment[nn]=Nepomuk-filantologien definerer grunnleggjande filtypar
...
Comment[wa]=L' ontolodjeye di fitchîs nepomuk definixh des sôres di fitchîs di båze
Comment[x-test]=xxThe Nepomuk File Ontology defines basic file typesxx
...
Path=${ONTO_INSTALL_DIR}/nfo.trig
