...
Name[ar]=?????? ????? ????????
Name[ca]=Els termes del 'Dublin Core'
...
Name[hu]=Dublin alapfogalmak
Name[kk]=Dublin Core шарттары
Name[km]=???????????? Dublin
Name[kn]=??????? ???? ????????? ???????
Name[ko]=더블린 코어 용어
...
Name[wa]=Les termes soûmint d' Dublin
Name[x-test]=xxThe Dublin Core Termsxx
Name[zh_CN]=都柏林核心术语
Name[zh_TW]=Dublin 核心術語
Comment=The Dublin Core Terms
Comment[ar]=?????? ????? ????????
Comment[ca]=Els termes del 'Dublin Core'
...
Comment[hu]=Dublin alapfogalmak
Comment[kk]=Dublin Core шарттары
Comment[km]=????????????? Dublin
Comment[kn]=??????? ???? ????????? ???????
...
Comment[wa]=Les termes soûmint d' Dublin
Comment[x-test]=xxThe Dublin Core Termsxx
