...
Name[hu]=Dublin elemkészlet
Name[kk]=Dublin Core элемент жиыны
...
Name[wa]=Li djeu d' elemints soûmint d' Dublin
Name[x-test]=xxThe Dublin Core Element Setxx
Name[zh_CN]=都柏林核心元素集
Name[zh_TW]=Dublin 核心元素集
Comment=The Dublin Core Element Set v1.1 namespace providing access to its content by means of an RDF Schema
Comment[ar]=مساحة أسماء مجموعة العناصر الجوهرية دابلن ن1.1 التي توفر النفاذ إلى محتواها بواسطة مبيان RFG
Comment[ca]=L'espai de noms del conjunt d'elements 'Dublin Core' v1.1 proporciona l'accés al seu contingut mitjançant un esquema RDF
Comment[csb]=Rum mionów The Dublin Core Element Set v1.1 dôwô przistãp do jegò zamkłoscë bez RDF Schema 
...
Comment[hu]=A Dublin elemkészlet v1.1 névtéren keresztül lehet elérni az adattartalmat (RDF sémával)
Comment[kk]=Мазмұнына RDF Schema арқылы қатынауға мүмкіндік беретін Dublin Core элемент жиынның 1.1 нұсқасының орынбасары
...
Comment[nn]=Dublin Core-elementa versjon 1.1-namnerom som gjev tilgang til innhaldet via eit RDF-skjema
...
Comment[wa]=L' espåce di lomaedje do djeu d' elemints soûmint d' Dublin modêye 1.1, ki dene accès a s' contnou eviè on chema RDF
Comment[x-test]=xxThe Dublin Core Element Set v1.1 namespace providing access to its content by means of an RDF Schemaxx
